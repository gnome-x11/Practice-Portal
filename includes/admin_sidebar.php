    ...
    <div class="container-fluid">
      ...
      <ul class="nav justify-content-end" id="navbar">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="*" href="#" role="button"
            aria-expanded="false">Manage Faculty Account</a>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="*" href="admin/"
            role="button" aria-expanded="false">Manage Students</a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="junior_high_admission.php">Online Addmission (Junior High School)
                Application</a></li>
            <li><a class="dropdown-item" href="senior_high_admission.php">Online Addmission (Senior High School)
                Application</a></li>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="*" href="" role="button"
            aria-expanded="false">Manage Content</a>
          <ul class="dropdown-menu">
